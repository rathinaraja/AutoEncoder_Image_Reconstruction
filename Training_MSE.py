...
def main():    
    ...
    checkpoint_dir = Config.model_saved_location_mse
    ...
    training_loss_file = Config.training_loss_file_mse
    save_training_loss(train_recon_losses, training_loss_file)

    # Save the final model 
    save_model(model, f"{checkpoint_dir}/Final_Model_AE_MSE.pth")
